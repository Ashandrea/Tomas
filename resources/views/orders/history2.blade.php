                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="pt-3 mt-3 border-t border-gray-200">
                                                ...
                                                <div class="flex justify-between items-center mt-1">
                                                    ...
                                                    <p class="text-sm text-gray-900">Rp {{ number_format($order->delivery_fee ?? 0, 0, ',', '.') }}</p>
                                                </div>
                                                <div class="flex justify-between items-center mt-3 pt-3 border-t border-gray-200">
                                                    <p class="text-base font-semibold text-gray-900">{{ __('Total') }}</p>
                                                    <p class="text-base font-semibold text-gray-900">Rp {{ number_format($order->total_amount + ($order->delivery_fee ?? 0), 0, ',', '.') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
