            ...
            <div class="flex flex-col items-center md:flex-row">
                <div class="md:w-1/2 transform transition-all duration-1000 ease-out"
                    ...
                    <h1 class="text-4xl font-bold leading-tight text-gray-800 md:text-5xl lg:text-6xl">
                        Makanan Lezat <br>
                        <span class="bg-gradient-to-r from-[#213448] to-[#547792] bg-clip-text text-transparent">Diantar</span> ke Tempat Anda
                    </h1>
                    <p class="mt-4 text-lg text-gray-600">
                        Pesan makanan favorit Anda dari penjual terbaik di sekitar kampus dan dapatkan pengiriman cepat langsung ke tempat Anda.
                    </p>
                        ...
                        <div class="absolute -right-6 -top-6 hidden rounded-xl bg-white p-4 shadow-lg md:block transform transition-all delay-700 duration-700"
                            ...
                            <div class="flex items-center">
                                <div class="rounded-full bg-[#e6eaee] p-3">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 text-[#213448]">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                                    </svg>

                                </div>
                                <div class="ml-3">
                                    <p class="text-xs text-gray-500">Only for</p>
                                    <p class="font-semibold text-gray-800">Cash on Delivery (COD)</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="relative z-10 mt-12 rounded-t-3xl bg-white/80 py-12 backdrop-blur-sm">
        <div class="container mx-auto px-6">
            <div class="mb-12 text-center">
                ...
                <p class="mt-2 text-gray-600">Pilih dari berbagai makanan lezat kami</p>
            </div>
