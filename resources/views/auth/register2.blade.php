                        ...
                        <form class="space-y-4 sm:space-y-5" method="POST" action="{{ route('register') }}">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="name" class="block w-full rounded-lg border-gray-300 pl-10 text-sm focus:border-orange-500 focus:ring-orange-500" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Nama lengkap Anda">
                                </div>
                                @error('name')
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="email" class="block w-full rounded-lg border-gray-300 pl-10 text-sm focus:border-orange-500 focus:ring-orange-500" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="email@contoh.com">
                                </div>
                                @error('email')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="phone" class="block w-full rounded-lg border-gray-300 pl-10 text-sm focus:border-orange-500 focus:ring-orange-500" type="tel" name="phone" value="{{ old('phone') }}" required autocomplete="tel" placeholder="0812-3456-7890">
                                </div>
                                @error('phone')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select id="role" name="role" class="block w-full rounded-lg border-gray-300 pl-10 pr-3 py-2 text-sm focus:border-orange-500 focus:ring-orange-500" required>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="password" class="block w-full rounded-lg border-gray-300 pl-10 text-sm focus:border-orange-500 focus:ring-orange-500" type="password" name="password" required autocomplete="new-password" placeholder="••••••••">
                                </div>
                                @error('password')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="password_confirmation" class="block w-full rounded-lg border-gray-300 pl-10 text-sm focus:border-orange-500 focus:ring-orange-500" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••">
                                </div>
                            </div>
