        ...
        <div class="w-full max-w-md">
            ...
            <div class="fixed inset-0 z-0 hidden overflow-hidden sm:block">
                <div class="left-1/6 animate-float absolute top-1/4">
                    <svg class="h-12 w-12 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="animate-float animation-delay-3000 absolute bottom-1/4 left-1/4">
                    <svg class="h-14 w-14 text-white opacity-70" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="animate__animated animate__fadeIn w-full overflow-hidden rounded-2xl border border-white/20 bg-white/80 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl sm:max-w-md">
                    <div class="p-6 sm:p-8">
                        ...
                        <div class="mb-4 text-center sm:mb-6">
                            ...
                            <h1 class="text-xl font-bold text-gray-800 sm:text-2xl">{{ __('Selamat Datang Kembali!') }}</h1>
                            <p class="mt-1 text-xs text-gray-600 sm:text-sm">{{ __('Masuk untuk memesan makanan favorit Anda') }}</p>
                        </div>
                        ...
                        <form class="space-y-4 sm:space-y-5" method="POST" action="{{ route('login') }}">
                            ...
                            <!-- Email/Phone Field -->
                            <div>
                                <label class="mb-1 block text-xs font-medium text-gray-700 sm:text-sm" for="login">{{ __('Email atau Nomor Telepon') }}</label>
                                <div class="relative">
                                    ...
                                    <input
                                        class="block w-full rounded-lg border border-gray-300 py-2 pl-9 pr-3 text-xs shadow-sm transition duration-200 focus:border-[#213448] focus:ring-2 focus:ring-[#213448] sm:pl-10 sm:text-sm"
                                        id="login"
                                        name="login"
                                        type="text"
                                        value="{{ old('login') }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        class="block w-full rounded-lg border border-gray-300 py-2 pl-9 pr-3 text-xs shadow-sm transition duration-200 focus:border-orange-500 focus:ring-2 focus:ring-[#547792] sm:pl-10 sm:text-sm"
                                        id="password"
                                        name="password"
                                        type="password"
                                        required
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <input class="h-4 w-4 rounded border-gray-300 text-orange-600 focus:ring-[#547792]" id="remember_me" name="remember" type="checkbox">
                                    <label class="ml-2 block text-xs text-gray-700 sm:text-sm" for="remember_me">{{ __('Ingat saya') }}</label>
                                </div>
                            ...
                            <!-- Login Button -->
                            <button class="flex w-full transform items-center justify-center rounded-lg border border-transparent bg-gradient-to-r from-[#213448] to-[#547792] px-4 py-2 text-xs font-medium text-white shadow-sm transition-all duration-300 hover:scale-[1.02] hover:[#213448] hover:to-[#547792] focus:outline-none focus:ring-2 focus:ring-[#213448] focus:ring-offset-2 sm:text-sm" type="submit">
                                <svg
                        ...
                        <div class="mt-4 text-center sm:mt-6">
                            <p class="text-xs text-gray-600 sm:text-sm">
                                {{ __("Belum punya akun?") }}
                                <a class="font-medium text-[#213448] transition duration-200 hover:text-[#547792]" href="{{ route('register') }}">
                                    {{ __('Daftar Sekarang') }}
                                </a>
                            </p>
                        </div>
